        ...
        {tab === 'slots' && (
          <div className="space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 text-sm text-amber-800">
              <p className="font-semibold mb-1 flex items-center gap-2"><FiAlertCircle size={15}/> Blocking Slots</p>
              <p className="text-xs">To block a slot for leave or holiday, use the API endpoint <code className="bg-amber-100 px-1 rounded">PUT /api/doctors/me/slots/:slotId/block</code> or add a block slots UI here.</p>
            </div>
          </div>
        )}
